...
\begin{figure}[!t]
\centering
\subfloat[A plume from Sakurajima Volcano eruption\cite{PlumePhoto}]{\includegraphics[width=3.8cm,height=4.5cm]{plume_photo}}
\label{fig:plume_photo}
\hfil
\subfloat[Contour of mass fraction of erupted material at 290 seconds]{\includegraphics[width=3.8cm,height=4.5cm]{Plume_simulation}}
