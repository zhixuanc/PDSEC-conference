...
There are several review papers \cite{monaghan1992smoothed, monaghan2005smoothed, price2012smoothed, monaghan2012smoothed} which provide a pretty comprehensive descriptions of SPH. These may be consulted for additional details. %We will not cover the basic theory of SPH in this paper.
...
%These fluctuations are due to sharing nodes with other users. In addition, difference in simulation time for different processors are obvious.
\\
